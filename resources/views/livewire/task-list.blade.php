...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex justify-center">
            <div class="px-6 pt-6 text-gray-900 dark:text-gray-100 w-full">
                <table class="w-full table-fixed border-separate border-spacing-y-2">
                        ...
                        <tr class="even:dark:bg-gray-700/20">
                            <td class="text-sm">
                                <x-secondary-button wire:click="changeStatus({{$task->id}})" class="group text-black m-0.5 focus:ring-0 group aspect-square" style="padding: 8px">
                                    <div class="group-hover:visible {{$task->status ? 'visible' : 'invisible'}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4" stroke="{{$task->status ? 'green' : 'currentColor'}}" class="size-4 group-hover:opacity-60">
                    ...
                    <caption class="caption-bottom h-8 mt-2">
